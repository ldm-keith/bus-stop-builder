...
= v0.5.0402
Added Amenities Added list to saved design Viewer Page

= v0.5.0426
Added "Send Back" and "Send Forward" model controls

= v0.5.0513
Added "Amentiey Added Icons to Builder Page"

= v0.5.0731
Added "X"  to library popup for mobile
Added support for compressed GLB models (DRACO compression)
